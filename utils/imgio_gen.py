...
def visulize_attention_ratio(img, save_path, attention_mask, ratio=0.25, cmap="jet"):
    """
    ...
    # attention_mask = torchvision.transforms.ToPILImage()(attention_mask.cpu()).convert("L")
    # attention_mask = attention_mask.cpu().numpy()
    img_h, img_w = img.size[0], img.size[1]
    plt.subplots(nrows=1, ncols=1, figsize=(0.005 * img_h, 0.005 * img_w))
    ...
    plt.close()
    # img.save("exp_log/original.png", quality=100)
